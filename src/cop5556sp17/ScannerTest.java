...
public class ScannerTest {
	...
	@Test
	public void testWhiteSpaces() throws IllegalCharException,
			IllegalNumberException {
		...
		assertEquals("eof", scanner.tokens.get(0).getText()); // only EOF
	}
...
//	@Test
//	public void testWhiteSpacesWithChars() throws IllegalCharException,
//			IllegalNumberException {
//		// test: tokens array is empty, lineStarts has 2 entries
//		String input = "  \n  \r**&  \n";
//		// create and initialize the scanner
...
//		assertEquals("eof", scanner.tokens.get(0).getText());
//		assertEquals(0, scanner.lineStartsList.get(0).intValue()); // 1st line
//		assertEquals(9, scanner.lineStartsList.get(1).intValue());
//		// get the first token and check its kind, position, and contents (length and text)
//		Scanner.Token token = scanner.nextToken();
//		assertEquals(SEMI, token.kind);
//		assertEquals(0, token.pos);
